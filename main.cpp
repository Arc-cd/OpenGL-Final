...
void paintGL(){
	...
	myPlayerRender(m_myCameraManager->playerProjectionMatrix(), m_myCameraManager->playerViewMatrix(), m_myCameraManager, m_imguiPanel);
	defaultRenderer->m_shaderProgram->useProgram();
	...
	myGodRender(m_myCameraManager->godProjectionMatrix(), m_myCameraManager->godViewMatrix(), m_myCameraManager, m_imguiPanel);
	defaultRenderer->m_shaderProgram->useProgram();
